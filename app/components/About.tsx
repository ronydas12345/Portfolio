  ...
  return (
    <section className="w-full min-h-screen bg-white py-20 px-8">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-6xl font-bold text-black mb-8">About Me</h2>
        ...
        <div className="space-y-6 text-lg text-gray-700">
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 bg-slate-50 p-8 rounded-lg">
            <div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-black mb-3">Experience</h3>
              <ul className="space-y-2 text-gray-700">
